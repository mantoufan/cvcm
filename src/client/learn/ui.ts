...
function groupOf(id: TutorialId): string {
  ...
  if (id === "count-words" || id === "make-password" || id === "format-json" || id === "decode-base64" || id === "unix-time" || id === "read-jwt" || id === "count-workdays" || id === "simplify-fraction" || id === "hourly-pay" || id === "convert-timezone" || id === "profit-margin" || id === "convert-base" || id === "add-duration" || id === "calculate-percent" || id === "days-between" || id === "shift-date" || id === "iso-week" || id === "vat-price" || id === "percent-off" || id === "encode-url" || id === "calculate-age" || id === "aspect-ratio" || id === "calculate-bmi" || id === "split-tip" || id === "loan-payment" || id === "read-cron") return "text";

...
export const TOOL_COVER: Record<ToolId, string> = {
  ...
  meme: "/covers/meme-sweet.jpg?v=1",
  signature: "/covers/signature-sweet.jpg?v=1",
  ...
  invoice: "/covers/invoice-sweet.jpg?v=1",
  ...
  "text-to-speech": "/covers/text-to-speech-sweet.jpg?v=1",
};

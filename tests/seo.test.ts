...
describe("seo helpers", () => {
  ...
  it("builds five FAQ items and FAQPage JSON-LD per tool", () => {
    const tools = [
      "clip", "qr", "barcode", "watermark", "collage", "resize", "crop", "convert", "image-pdf", "pdf-jpg", "merge-pdf", "compress-pdf", "split-pdf", "audio", "data", "password", "word-count", "color", "names", "timezone", "lorem", "units",
    ] as const;

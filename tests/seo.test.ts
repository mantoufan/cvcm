...
describe("seo helpers", () => {
  it("uses keyword-rich titles and descriptions", () => {
    ...
    expect(pageTitle("en", "sort")).toMatch(/Sort lines/i);
    expect(pageTitle("en", "replace")).toMatch(/Find and replace/i);
    expect(pageTitle("en", "words")).toMatch(/Number to words/i);
    ...
    expect(pageTitle("en", "margin")).toMatch(/Profit margin/i);
    expect(pageTitle("en", "radix")).toMatch(/Base converter/i);
    expect(pageTitle("en", "duration")).toMatch(/Time duration/i);
    expect(pageTitle("zh-CN", "margin")).toMatch(/利润率/);
    expect(pageTitle("zh-CN", "radix")).toMatch(/进制/);
    expect(pageTitle("zh-CN", "duration")).toMatch(/时长/);
